...
library(VennDiagram)
library(export)
setwd("C:/Users/CSIV149/PLC.lab.docs/04.hanjian/for.JingHe.July/Filtered.METTL3.eCLIP.peaks.bound.by.DAP3/")
#10:100:67 
bins_overlapping_peaks_with_sh.1.1 = read.delim("cds_bins_overlapped_Filtered_KD1-1_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_5utr_with_sh.1.1 = read.delim("5utr_bins_overlapped_Filtered_KD1-1_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_3utr_with_sh.1.1 = read.delim("3utr_bins_overlapped_Filtered_KD1-1_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
...
bins_overlapping_peaks_with_sh.1.2 = read.delim("cds_bins_overlapped_Filtered_KD1-2_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_5utr_with_sh.1.2 = read.delim("5utr_bins_overlapped_Filtered_KD1-2_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_3utr_with_sh.1.2 = read.delim("3utr_bins_overlapped_Filtered_KD1-2_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
...
bins_overlapping_peaks_with_sh.2.1 = read.delim("cds_bins_overlapped_Filtered_KD2-1_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_5utr_with_sh.2.1 = read.delim("5utr_bins_overlapped_Filtered_KD2-1_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_3utr_with_sh.2.1 = read.delim("3utr_bins_overlapped_Filtered_KD2-1_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
...
bins_overlapping_peaks_with_sh.2.2 = read.delim("cds_bins_overlapped_Filtered_KD2-2_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_5utr_with_sh.2.2 = read.delim("5utr_bins_overlapped_Filtered_KD2-2_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_3utr_with_sh.2.2 = read.delim("3utr_bins_overlapped_Filtered_KD2-2_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
...
bins_overlapping_peaks_with_Scr.1 = read.delim("cds_bins_overlapped_Filtered_SCR1_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_5utr_with_Scr.1 = read.delim("5utr_bins_overlapped_Filtered_SCR1_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_3utr_with_Scr.1 = read.delim("3utr_bins_overlapped_Filtered_SCR1_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
...
bins_overlapping_peaks_with_Scr.2 = read.delim("cds_bins_overlapped_Filtered_SCR2_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_5utr_with_Scr.2 = read.delim("5utr_bins_overlapped_Filtered_SCR2_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
bins_overlapping_peaks_3utr_with_Scr.2 = read.delim("3utr_bins_overlapped_Filtered_SCR2_M3_eCLIP_peak_bound_by_DAP3.geneAnno.out_with.TPM_0.1.txt", stringsAsFactors = F, header = F, check.names = F, sep = "\t")
...
graph2ppt(file="MetaPlot_Filtered.METTL3.eCLIP.peaks.bound.by.DAP3.pptx", width=8, aspectr=1.5)
